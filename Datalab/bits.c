...
{
  int last4bits = (x & 0b1111); // 0000~1001
  return (!((x >> 4) ^ 0b11)) & (!(last4bits >> 3) | !(last4bits ^ 0b1001) | !(last4bits ^ 0b1000));
}
/*
...
{
  int trueMask = (!!x) << 31 >> 31;
  int falseMask = (!x) << 31 >> 31;
